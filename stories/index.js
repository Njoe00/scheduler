...
storiesOf("Button", module)
  ...
  .add("Edit", () => <Form student="Nick" interviewer={3} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")} onChange={action("setInterviewer")} /> )
  ...
  .add("Appointment Booked" , () => (
    <Fragment>
      <Appointment time="4pm" id={1} interview={{ student: "Lydia Miller-Jones", interviewer}}/>
      <Appointment time="5pm"/>
    </Fragment>
  ))
