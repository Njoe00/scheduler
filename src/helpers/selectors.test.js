...
// false data to pass to selectors functions to keep same data being tested
const state = {
  days: [
    {
      id: 1,
...
// tests to ensure selectors functions are performing their functions properly
...
test("getInterviewersForDay returns an array containing the correct interviewers arry", () => {
